...
Напишем программу, которая для каждого токена берет последний бит (младший). Все эти младшие биты последовательно соединяет в одну длинную битовую строку. После получения этой строки разбивает ее на группы по восемь бит и каждую такую группу переводит в символ ASCII.
